...
class AddInfo extends Component{
    ...
    onSubmit = (e) => {
        ...
        if(name && name.length <= 30 && isNaN(age) === false && age > 0 && age < 80 && email && this.validateEmail()){
            ...
            this.setState({errAdd: false})
        }else{
            this.setState({errAdd: true})
        }
    ...
    render() {
        return (
            <div className="panel panel-warning p-4 mt-3 mb-4">
                ...
                <div className="panel-body">
                    <form >
                        ...
                        {this.state.errAdd === true && (<p className="text-danger mt-1 mb-1">(*) Please enter full information and correct format!</p>) }
                    </form>
                </div>
            </div>
        );
